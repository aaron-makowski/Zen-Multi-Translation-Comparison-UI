    ...
    <main className="flex min-h-screen flex-col items-center p-4 md:p-24">
      <div className="max-w-4xl w-full">
        <div className="mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold">Verse {verse.number}</h1>
          <p className="text-gray-600">{verse.book.title}</p>
        </div>

        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-8">
          <h2 className="text-lg md:text-xl font-semibold mb-4">Translations</h2>

          <div className="flex md:block overflow-x-auto md:space-y-6 -mx-4 md:mx-0 snap-x snap-mandatory">
            {verse.translations.map((translation) => (
              <div
                key={translation.id}
                className="min-w-full md:min-w-0 px-4 md:px-0 snap-center md:border-b md:pb-4 md:last:border-b-0 md:last:pb-0"
              >
